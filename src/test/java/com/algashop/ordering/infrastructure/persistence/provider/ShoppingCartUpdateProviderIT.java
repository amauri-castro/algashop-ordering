...
import com.algashop.ordering.infrastructure.persistence.shoppingcart.ShoppingCartUpdateProvider;
...
public class ShoppingCartUpdateProviderIT {
    ...
    void shouldUpdateItemPriceAndTotalAmount() {
        ...
        Product product1 = ProductTestDataBuilder.aProductMacbook().price(new Money("2000")).build();
        ...
        Money expectNewCartTotalAmount = expectedNewItemTotalPrice.add(new Money("200"));
        ...
        Assertions.assertThat(updatedShoppingCart.totalAmount()).isEqualTo(expectNewCartTotalAmount);
    ...
    void shouldUpdateItemAvailability() {
        ...
        Product product1 = ProductTestDataBuilder.aProductMacbook()
