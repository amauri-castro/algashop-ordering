...
class CustomersIT {
    ...
    public void shouldNotFindByEmailIfNoCustomerExistsWithEmail() {
        Optional<Customer> possibleCustomer = customers
                .ofEmail(new Email(UUID.randomUUID() + "@email.com"));

        Assertions.assertThat(possibleCustomer).isNotPresent();
    }
    ...
    public void shouldReturnIfEmailIsInUse() {
        ...
        Assertions.assertThat(customers.isEmailUnique(
                new Email("amauricastro@email.com"), new CustomerId())).isTrue();
