...
class CustomerManagementApplicationServiceIT extends AbstractApplicationIT {
    ...
    public void shouldThrowCustomerEmailIsInUseExceptionWhenReuseEmail() {
        ...
        UUID customerId1 = customerManagementApplicationService.create(CustomerTestDataBuilder.DEFAULT_CUSTOMER_ID.value(), input1);
        UUID customerId2 = customerManagementApplicationService.create(CustomerTestDataBuilder.ALTERNATIVE_CUSTOMER_ID.value(), input2);
