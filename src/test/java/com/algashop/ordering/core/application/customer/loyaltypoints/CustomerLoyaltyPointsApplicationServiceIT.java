package com.algashop.ordering.core.application.customer.loyaltypoints;
...
class CustomerLoyaltyPointsApplicationServiceIT extends AbstractApplicationIT {
    ...
    void shouldAddLoyaltyPointsToCustomerWhenOrderIsValidAndReady() {
        ...
        Order order = OrderTestDataBuilder.anOrder()
                ...
                .withItems(false)
                .build();
        Product product = ProductTestDataBuilder.aProductMacbook().price(new Money("2500")).build();
    ...
    void shouldNotAddLoyaltyPointsWhenOrderAmountIsLessThanThreshold() {
        ...
        Order order = OrderTestDataBuilder.anOrder()
                ...
                .withItems(false)
                .build();
        Product product = ProductTestDataBuilder.aProductMacbook().price(new Money("500")).build();
