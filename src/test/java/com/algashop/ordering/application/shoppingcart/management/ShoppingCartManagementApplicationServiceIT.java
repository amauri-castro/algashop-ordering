...
class ShoppingCartManagementApplicationServiceIT {
    ...
    void shouldCreateNewShoppingCartForExistingCustomer() {
        ...
        Optional<ShoppingCart> createdCart = shoppingCarts.ofId(new com.algashop.ordering.domain.model.shoppingcart.ShoppingCartId(newShoppingCartId));
    ...
    void shouldAddItemToShoppingCartSuccessfully() {
        ...
        Product product = ProductTestDataBuilder.aProductMacbook().inStock(true).build();
        ...
        Mockito.verify(eventListener).listen(Mockito.any(ShoppingCartItemAddedEvent.class));
    }
    ...
    void shouldThrowProductOutOfStockExceptionWhenAddingOutOfStockProduct() {
        ...
        Product outOfStockProduct = ProductTestDataBuilder.aProductMacbook().inStock(false).build();
    ...
    void shouldRemoveItemFromShoppingCartSuccessfully() {
        ...
        Mockito.verify(eventListener).listen(Mockito.any(ShoppingCartItemRemovedEvent.class));
    }
    ...
    void shouldEmptyShoppingCartSuccessfully() {
        ...
        customers.add(customer);
        ShoppingCart shoppingCart = ShoppingCart.startShopping(customer.id());
        shoppingCart.addItem(ProductTestDataBuilder.aProductMacbook().inStock(true).build(), new Quantity(1));
        shoppingCarts.add(shoppingCart);
        ...
        Mockito.verify(eventListener).listen(Mockito.any(ShoppingCartEmptiedEvent.class));
    }
