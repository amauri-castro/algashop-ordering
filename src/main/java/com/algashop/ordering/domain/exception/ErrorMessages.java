...
public class ErrorMessages {
    ...
    public static final String ERROR_ORDER_DELIVERY_DATE_CANNOT_IN_THE_PAST
            = "Order %s expected delivery date cannot in the past";
    ...
    public static final String ERROR_ORDER_CANNOT_BE_PLACED_INVALID_EXPECTED_DELIVERY_DATE
            = "Order %s cannot be closed, it has invalid expected delivery date";
    ...
    public static final String ERRO_ORDER_DOES_NOT_CONTAIN_ITEM
