...
import com.algashop.ordering.domain.exception.ShoppingCartItemIncompatibleException;
...
import com.algashop.ordering.domain.valueobject.id.*;
...
public class ShoppingCartItem {
    ...
    public ShoppingCartItem(ShoppingCartItemId id, ShoppingCartId shoppingCartId,
                            ...
                            Quantity quantity, Boolean available, Money totalAmount) {
        this.setId(id);
    ...
    public ShoppingCartItem(ShoppingCartId shoppingCartId, ProductId productId, ProductName productName,
        ...
        this(new ShoppingCartItemId(), shoppingCartId, productId,
                productName, price, quantity, available, Money.ZERO);
    ...
    void refresh(Product product) {
        ...
        if (!product.id().equals(this.productId())) {
            throw new ShoppingCartItemIncompatibleException(this.id(), product.id());
        }
